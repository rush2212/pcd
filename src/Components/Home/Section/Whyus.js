...
const Whyus = () => {
  return (
    ...
    <div class="container">
      <div class="row">
        <div className={`${styles["section-head"]} col-sm-12`}>
        ...
        <div class="col-lg-4 col-sm-6">
          <div className={styles.item}> <span className={`${styles.icon} ${styles.feature_box_col_one}`}><i class="bi bi-globe"></i></span>
            <h6>Modern Design</h6>
            <p>We use latest technology for the latest world because we know the demand of peoples.</p>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6">
        <div className={styles.item}> <span className={`${styles.icon} ${styles.feature_box_col_two}`}><i class="bi bi-globe"></i></span>
            <h6>Creative Design</h6>
            <p>We are always creative and and always lisen our costomers and we mix these two things and make beast design.</p>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6">
        <div className={styles.item}> <span className={`${styles.icon} ${styles.feature_box_col_three}`}><i class="bi bi-globe"></i></span>
            <h6>24 x 7 User Support</h6>
            <p>If our customer has any problem and any query we are always happy to help then.</p>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6">
        <div className={styles.item}> <span className={`${styles.icon} ${styles.feature_box_col_four}`}><i class="bi bi-globe"></i></span>
            <h6>Business Growth</h6>
            <p>Everyone wants to live on top of the mountain, but all the happiness and growth occurs while you're climbing it</p>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6">
        <div className={styles.item}> <span className={`${styles.icon} ${styles.feature_box_col_five}`}><i class="bi bi-globe"></i></span>
        ...
        <div class="col-lg-4 col-sm-6">
        <div className={styles.item}> <span className={`${styles.icon} ${styles.feature_box_col_six}`}><i class="bi bi-globe"></i></span>
